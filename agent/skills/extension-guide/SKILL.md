...
- Avoid emojis, slang, and informal expressions
...
**Prefer single-file extensions for simple extensions** (< 500 lines, no external dependencies, no helper modules).

| Layout | When to use |
|--------|-------------|
| `extensions/my-ext.ts` (single file) | **Preferred** for simple extensions — no `package.json` or subfolder needed |
...
**Use single-file (`my-ext.ts`) when:**
- Extension is < 500 lines of code
- No external npm dependencies
- No helper modules or utilities
- Simple, self-contained functionality
- Easier to maintain and understand

**Use directory structure (`my-ext/index.ts`) when:**
- Extension has multiple source files
- Requires external npm dependencies
- Complex functionality with helper modules
- Needs separate configuration or asset files
- Extension is large (> 500 lines)
